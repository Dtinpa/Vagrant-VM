...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "virtualbox-ubuntu22.04"
  config.vm.network :forwarded_port, guest: 80, host: 8080, ip: "172.30.1.5"
  config.vm.synced_folder "project/GenerateStand", "/vagrant"
